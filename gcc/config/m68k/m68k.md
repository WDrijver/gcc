...
;; APOLLO LINEA NOT YET ENABLED -> || TARGET_68080 in lines 1865 and 1882
...
;; APOLLO LINEA NOT YET ENABLED ->  || TARGET_68080 in line 3812
  ...
  "!TARGET_COLDFIRE"
{
  ...
  if (DATA_REG_P (operands[0]))
	{
    if (TUNE_68080)
            return "dbra.l %0,%l1";                 // APOLLO 68080 DBRAL
    if (TUNE_68060)
...
;; DISABLED BY APOLLO DUE TO ISSUES
...
;; APOLLO LINEA MOVE2 NOT YET ENABLED
